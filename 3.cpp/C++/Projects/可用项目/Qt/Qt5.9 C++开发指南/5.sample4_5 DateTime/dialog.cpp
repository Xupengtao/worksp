...
void Dialog::on_timer_timeout()                             // 定时器中断响应槽函数
{
...
void Dialog::on_btnGetTime_clicked()                        // 获取当前日期时间，为三个专用编辑器设置日期时间数据，并转换为字符串在LineEdit里显示
{
...
void Dialog::on_calendarWidget_selectionChanged()           // 在日历上选择日期
{
...
void Dialog::on_btnSetTime_clicked()                        // 字符串转换为QTime
{
