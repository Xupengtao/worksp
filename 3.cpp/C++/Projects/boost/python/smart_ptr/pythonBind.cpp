...
{
    bp::class_<base_wrapper_t, boost::noncopyable, smart_pointers::smart_ptr_t<base_wrapper_t>>("base_i")
        // -----------^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
    ...
    bp::implicitly_convertible<smart_pointers::smart_ptr_t<base_wrapper_t>, smart_pointers::smart_ptr_t<base_i>>();
    ...
    bp::class_<derived_wrapper_t, bp::bases<base_i>, smart_pointers::smart_ptr_t<derived_wrapper_t>>("derived_t")
        // -----------^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
    ...
    bp::implicitly_convertible<smart_pointers::smart_ptr_t<derived_wrapper_t>, smart_pointers::smart_ptr_t<derived_t>>();
    bp::implicitly_convertible<smart_pointers::smart_ptr_t<derived_t>, smart_pointers::smart_ptr_t<base_i>>();
    bp::implicitly_convertible<derived_ptr_t, smart_pointers::smart_ptr_t<derived_t>>();
    ...
    bp::class_<shared_data::buffer_holder_t>("buffer_holder_t")
        ...
        .add_property("data", bp::make_getter(&shared_data::buffer_holder_t::data, bp::return_value_policy<bp::copy_non_const_reference>()), bp::make_setter(&shared_data::buffer_holder_t::data));
}