...
struct derived_ptr_t : public smart_pointers::smart_ptr_t<derived_t>
{
    ...
    explicit derived_ptr_t(derived_t *rep) : smart_pointers::smart_ptr_t<derived_t>(rep)
    {
        ;
    }
    derived_ptr_t(const derived_ptr_t &r) : smart_pointers::smart_ptr_t<derived_t>(r)
    {
        ;
    }
    derived_ptr_t(const smart_pointers::smart_ptr_t<base_i> &r) : smart_pointers::smart_ptr_t<derived_t>()
    {
...
inline int ref_get_value(smart_pointers::smart_ptr_t<base_i> &a)
{
    return a->get_value();
}
inline int val_get_value(smart_pointers::smart_ptr_t<base_i> a)
{
    return a->get_value();
}
inline int const_ref_get_value(const smart_pointers::smart_ptr_t<base_i> &a)
{
    return a->get_value();
}
struct numeric_t
...
{
    buffer_holder_t() : data(new buffer_t())
    {
        ;
    }
