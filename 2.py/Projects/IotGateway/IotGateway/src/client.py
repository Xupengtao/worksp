...
import logging
logging.basicConfig(filename='example_client.log',level=logging.INFO,format="%(asctime)s-%(name)s-%(levelname)s-%(message)s")
...
class PoetryProtocol(Protocol):
    ...
    def connectionMade(self):
        ...
        if self.index<10000:
            ...
            reactor.callLater(0,reactor.connectTCP,oppo.host,oppo.port,self.factory)
